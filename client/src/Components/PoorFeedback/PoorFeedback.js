...
export const PoorFeedback = () => {
  ...
  //   if (resp.adminName === "admin1") return true;
  //   if (resp.adminName === "admin2" && complaint.status === "closed")
  //     return true;
  //   return false;
  // });
  const filteredResponses = responses.filter((resp) => {
    if (resp.adminName === "admin1") return true;
    // Only show admin2 responses that were marked "closed" or visible to user
    if (resp.adminName === "admin2" && resp.status === "closed") return true;
    return false;
  });
  ...
  return (
    <div>
      <Admin2_nav />
      <div className="UnsatisfiedComplaint">
        <h1>Poor Feedback / Unsatisfied Complaint</h1>

        <div className="Unsatisfied_cmp">
          <h2>Complaint Information</h2>
          <div className="Unsatisfied_cmp_details">
            <p>
        ...
        <div className="cmp_history_box">
          <h2>Complaint History</h2>
          {/* <p>
            <b>User Feedback:</b> {userFeedback || "No feedback available"}
          </p> */}
          <div className="feedback_display_box">
            <p>
              <b>User Feedback:</b>
            </p>
            <p>
